...
_reactDom2.default.render(_react2.default.createElement(_app2.default, { name: 'Taylor' }), document.getElementById("root"));
...
var _productListing = __webpack_require__(42);

var _productListing2 = _interopRequireDefault(_productListing);

var _redux = __webpack_require__(21);

var _plpReducers = __webpack_require__(80);

var _plpReducers2 = _interopRequireDefault(_plpReducers);
...
var store = (0, _redux.createStore)(_plpReducers2.default, { products: [] }, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
var _productCard = __webpack_require__(44);
...
var _plpActions = __webpack_require__(79);

var _plpActions2 = _interopRequireDefault(_plpActions);
...
var ProductListing = function (_React$Component) {
    ...
    _createClass(ProductListing, [{
        ...
        value: function componentDidMount() {
            this.props.dispatch(_plpActions2.default.getAllProducts());
        }
    }, {
        key: 'searchHandler',
        value: function searchHandler(searchKey) {
            this.props.dispatch(_plpActions2.default.searchProductByName(searchKey));
        }
    }, {
        key: 'createCardList',
        value: function createCardList() {

            var filteredCards = this.props.products;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-sm-2' },
                        _react2.default.createElement(_sorting2.default, null)
                    )
                ),
                _react2.default.createElement(
                    'div',
...
var mapDispatchFunctionToProps = function mapDispatchFunctionToProps(dispatch) {
    return {
        dispatch: dispatch
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchFunctionToProps)(ProductListing);
...
var _productCard = __webpack_require__(45);
...
var ProductCard = function (_React$Component) {
    ...
    _createClass(ProductCard, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: _productCard2.default.card + " col-sm-3" },
                _react2.default.createElement('img', { className: 'card-img-top', src: card.image, alt: 'Card image cap' }),
                _react2.default.createElement(
                    'div',
                    { className: 'card-body' },
                    _react2.default.createElement(
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!../../node_modules/postcss-loader/lib/index.js??ref--1-2!./product-card.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!../../node_modules/postcss-loader/lib/index.js??ref--1-2!./product-card.css");
...
// module
exports.push([module.i, ".AyX67up2FQv5bD4FkMu-J{\n    width: 200px;\n    min-height: 200px;\n    background-color: #eee;\n    margin: 10px;\n    padding: 20px;\n}", ""]);

// exports
exports.locals = {
	"card": "AyX67up2FQv5bD4FkMu-J"
};
    ...
    _createClass(Search, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { value: this.state.searchString,
                    onChange: function onChange(evt) {
                        _this2.onKeyInput(evt);
                    },
                    placeholder: "Type your search key workd here", type: "text" }),
                _react2.default.createElement(
                    "button",
                    { className: "btn btn-primary", onClick: function onClick(evt) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(24), __webpack_require__(70)(module)))
...
var getDataAction = function getDataAction(data) {
    return {
        type: "GET_DATA",
        data: data
    };
...
var searchAction = function searchAction(str) {
    return {
        type: "SEARCH",
        data: str
    };
...
var PLPActions = {
    ...
    searchProductByName: function searchProductByName(keyword) {
        var filteredData = [].concat(_toConsumableArray(cachedStore.products));
        if (keyword !== "") {
...
var PLPReducer = function PLPReducer() {
